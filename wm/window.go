...
func WindowRemove(wnd *Window) {
	wnd.ID = -1                              // Remove reference for apps
	wnd.Element.Call("remove")               // Remove html part
	delete(AllWindows, strconv.Itoa(wnd.ID)) // Remove from list
	return
}
