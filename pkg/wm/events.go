...
func InitializeGlobalMouseEvents() {
	...
	js.
		Global().
		Get("document").
		Call("addEventListener", "mousemove", js.FuncOf(func(this js.Value, args []js.Value) interface{} {
			// In "Move" mode
	...
	js.
		Global().
		Get("document").
		Call("addEventListener", "mousedown", js.FuncOf(func(this js.Value, args []js.Value) interface{} {
			...
			if args[0].Get("button").Int() == 0 {
				...
				js.Global().
					...
					Get("body").
					Get("style").
					Set("cursor", "url(assets/cursor.svg), auto")
			}
			return nil
		}))
	...
	js.Global().
		Get("document").
		Call("addEventListener", "mouseup", js.FuncOf(func(this js.Value, args []js.Value) interface{} {
